...
const routes = {
  ...
  "/work": ["Selected Work — Symbolic Development", "Nine live products with inspectable decisions, grounded proof, and public release evidence.", "/assets/og/auditscout.webp"],
