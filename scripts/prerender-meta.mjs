...
const routes = {
  ...
  "/work": ["Selected Work — Symbolic Development", "Ten live products with inspectable decisions, grounded proof, and public release evidence.", "/assets/og/auditscout.webp"],
  ...
  "/work/atlases": ["Atlases Case Study — Symbolic Development", "Interactive software-engineering guides with real browser sandboxes and no required signup.", "/assets/products/atlases-1200.webp"],
  "/work/isymbolic": ["iSymbolic Case Study — Symbolic Development", "A technical publication and project archive documenting shipped software, AI, automation, games, and 3D work.", "/assets/products/isymbolic-blog-1200.webp"],
